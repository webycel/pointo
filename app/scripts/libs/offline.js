...
(function() {
  ...
  function() {
    ...
    for (_ref = ["up", "down"], _i = 0, _len = _ref.length; _len > _i; _i++) state = _ref[_i], (document.querySelector("script[data-simulate='" + state + "']") || ("undefined" != typeof localStorage && null !== localStorage ? localStorage.OFFLINE_SIMULATE : void 0) === state) && (null == Offline.options && (Offline.options = {}),
